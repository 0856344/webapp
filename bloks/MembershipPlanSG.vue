<template>
  <div v-editable="blok" :id="this.$vnode.key"
    ...
    <div v-for="item in features" :key="item?._uid"
      ...
      <div v-if="!isMobile">
        <span v-if="item == 'Coming Soon'" class="text-xl text-gray-400 transition duration-300">{{ item.toUpperCase()
        }}</span>
      ...
      <div v-else class="flex flex-col items-center">
        <span v-if="item.startsWith(comingSoonPrefix)"
          class="px-2 w-max font-bold bg-yellow rounded-md text-gray-900">Coming Soon</span>
