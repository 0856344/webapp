<template>
  <div v-editable="blok" :id="this.$vnode.key" class="grid grid-rows-plan-mobile lg:grid-rows-plan lg:h-screen w-72 lg:w-48 xl:w-56" >
    <div class="inline-flex items-center justify-center gap-4 bg-gray-900 rounded-t-lg text-yellow w-">
      <h2 class="uppercase">
        {{ blok.name }}
      </h2>
