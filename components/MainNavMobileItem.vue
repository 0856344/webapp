<template>
  <div class="nav-item">
    ...
    <div v-if="item.children && item.children.length > 0" class="main-nav-item">
      ...
      <transition
        ...
        name="fadefromright"
      >
        <div v-if="active" :key="item._uid" class="nav-layer">
          <div class="level-header">
            <div class="levelUp" @click="closeLayer()">
              <svg class="back-icon" viewBox="0 0 32 32" height="32" width="32">
                <g>
                  <path
                    d="M 26.894531 3.1035156 A 2.0002 2.0002 0 0 0 25.988281 3.3164062 L 4.6953125 13.679688 A 2.0003715 2.0003715 0 0 0 3.5742188 15.378906 A 2.0002 2.0002 0 0 0 4.6230469 17.462891 L 25.914062 28.927734 A 2.0002 2.0002 0 1 0 27.810547 25.40625 L 9.7382812 15.675781 L 27.738281 6.9140625 A 2.0002 2.0002 0 0 0 26.894531 3.1035156 z "
                  />
                </g>
              </svg>
            </div>
