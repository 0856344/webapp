      ...
      nextStepDisabled() {
        ...
        switch (this.activeStep) {
          ...
          case 'contact': {
            ...
            const allInvoiceContactFieldsSet = !requiredKeysInvoiceContact.filter(k => !data.billingInformation[k])
              .length
            ...
            return (
              !!requiredKeys.filter(k => !data.contactInformation[k]).length || !data.contactInformation.birthdateValid
            )
          }
          case 'image': {
    ...
    methods: {
          ...
          case 'contact':
            ...
            if (this.onboardingData.contactInformation.hasBillingAddress) {
              this.onboardingData.payment.accountOwner =
                this.onboardingData.billingInformation.firstName + ' ' + this.onboardingData.billingInformation.lastName
            } else {
              this.onboardingData.payment.accountOwner =
                this.onboardingData.userInformation.firstName + ' ' + this.onboardingData.userInformation.lastName
            }
      ...
      getMemberType() {
        ...
        if (
          ...
          !this.onboardingData.contactInformation.company?.metadata?.attendees_free_cost
        ) {
