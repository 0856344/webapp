  ...
  <div class="section">
    ...
    >
      ...
      <TextInput
        v-if="member.hasBillingAddress"
        :label="$t('zipCode')"
        v-model="member.billingZip"
        :isContact="true"
      />
      <TextInput
        v-if="member.hasBillingAddress"
        :label="$t('city')"
        v-model="member.billingCity"
        :isContact="true"
      />
      <div
        v-if="member.hasBillingAddress"
    ...
    >
      ...
      <TextInput
        ...
        v-model="paymentMethod.accountOwnerName"
        :isContact="true"
      />
      <div
        class="grid items-baseline grid-flow-row gap-2 grow sm:py-2 sm:grid-cols-contact"
      >
        <label
          class="block text-xs font-bold uppercase sm:text-end"
          for="checkbox"
        ...
        <div class="flex items-start gap-2">
          ...
          <div class="text-xs">
            ...
            gezogenen SEPA-Lastschriften einzulösen. Ich kann innerhalb von acht
        ...
        <div v-else class="flex w-5/6 gap-2 mt-6 sm:w-auto">
          ...
          <button
            ...
            :disabled="
              !sepaMandat ||
              !ibanIsValid ||
              paymentMethod.iban === currentIban ||
